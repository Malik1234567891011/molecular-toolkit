...
import { MECHANISMS, type Arrow, type MechStep, type Mechanism } from '@/lib/mechanisms';
...
const SUB = '₀₁₂₃₄₅₆₇₈₉';
function label(doc: MoleculeDocument, i: number, view: MolView): string {
  const a = doc.atoms[i];
...
function arrowPath(a: Arrow, byMap: Map<number, [number, number]>): number[][] | null {
  ...
  if ('lp' in a.from) start = [start[0], start[1] + 0.38];
